...
public class BattleSystem : MonoBehaviour
{
    ...
    public IEnumerator SetupBattle()
    {
        ...
        yield return dialogBox.TypeDialog($"A wild {enemyUnit.Pokemon.Base.GetName()} appeared.");
    ...
    IEnumerator RunMove(BattleUnit sourceUnit,BattleUnit targetUnit, Move move)
    {
        ...
        if (damageDetails.Fainted)
        {
            ...
            OnBattleOver(true); // true= the sourceUnit won
    ...
    IEnumerator SwitchPokemon(Pokemon newPokemon)
        {
            ...
            {
                yield return dialogBox.TypeDialog($"Come back {playerUnit.Pokemon.Base.GetName()}");
            ...
            yield return dialogBox.TypeDialog($"Go {newPokemon.Base.GetName()}!");
